...
public class ValueList<T> extends ForwardingList<T> {
    ...
    private ValueList(final boolean overridable) {
    ...
    public static <T> ValueList<T> copy(final ValueList<T> original) {
        final ValueList<T> newList = new ValueList<>(original.isOverridable());
