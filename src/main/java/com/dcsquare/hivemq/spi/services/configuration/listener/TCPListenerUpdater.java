 ...
 */
public interface TcpListenerUpdater {

    TcpListenerUpdater port(Integer port) throws ConfigurationNotOverridableException;


    TcpListenerUpdater bindAddress(String bindAddress) throws ConfigurationNotOverridableException;

    TcpListener update() throws ConfigurationValidationException;
