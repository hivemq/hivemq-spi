...
public interface WebsocketListenerUpdater {
    ...
    WebsocketListenerUpdater port(final Integer port);

    WebsocketListenerUpdater bindAddress(final String bindAddress);

    WebsocketListenerUpdater path(final String path);

    WebsocketListenerUpdater allowExtensions(final boolean allowExtensions);

    WebsocketListenerUpdater addSubprotocol(final String subprotocol);

    WebsocketListenerUpdater removeSubprotocol(final String subprotocols);
