 ...
 * {@link ScheduledCallback#cronExpression()} method.
 * <p/>
...
public interface ScheduledCallback extends AsynchronousCallback {
     ...
     * {@link CallbackRegistry}. If you have dynamic
     * cron expressions in this method, you must manually call the
     * {@link CallbackRegistry#reloadScheduledCallbackExpression(ScheduledCallback)}
